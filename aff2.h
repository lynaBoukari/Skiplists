...
int choix (void){
    int i,x=0,y=0,ch;
    chaine lechoix[]={ "   >>          Afficher la liste            <<  ",
...
delay(400);
  ...
  //**********************************************************************************************************************
    textbackground(15);
        ...
        printdirection("Annee Universitaire 2018/2019","right",49,2,30) ;
        decalrectangle(2);
textbackground(15);
gotoxy(35,10);
 printf("           %c%c%c%c%c%c%c%c%c%c        %c%c%c%c%c%c%c%c%c        \n",219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219) ;delay(50);gotoxy(35,11);
 ...
 printf("               %c%c            %c%c%c%c%c%c%c%c%c        \n",219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219,219);delay(50);gotoxy(35,14);
 printf("               %c%c            %c%c               \n",219,219,219,219,219,219,219);delay(50);gotoxy(35,15);
 printf("               %c%c            %c%c               ",219,219,219,219,219,219,219,219,219,219,219,219);
delay(300);
 decalrectangle(3);
textbackground(15);
textcolor(0);
...
printdirection("  ","down",60,23,35);
printdirection("aa ","down",59,23,35);
printdirection("nf ","down",58,23,35);
printdirection("ya1 ","down",57,23,35);
printdirection("LS0 ","down",56,23,35);
printdirection("||| ","down",54,23,35);
printdirection("ii  ","down",52,23,35);
printdirection("rce ","down",51,23,35);
printdirection("aip ","down",50,23,35);
printdirection("kuu ","down",49,23,35);
printdirection("uoo ","down",48,23,35);
printdirection("oar ","down",47,23,35);
printdirection("BLG ","down",46,23,35);
printdirection(" | Semestre 02","right",80,24,30);
printdirection("> Encadree par :       Dr A.Daoudi ","right",20,27,25);
textbackground(15);
...
void fin(void){
    ...
    textbackground(15);
    textcolor(0);
    printdirection("           Nous vous remercions d'avoir utilise notre programme    ","right",23,2,30 );
delay(1000);
decalrectangle(2);
decalrectangle(3);
gotoxy(15,10);
    ...
    printdirection(" Boukari Lyna ","right",24,16,15);
        textbackground(15);textcolor(0);
     printdirection(" e-mail: il_boukari@esi.dz ","right",17,18,15);
     textbackground(0);textcolor(15);
    printdirection(" Laouici Safa ","right",85,16,15);
        textbackground(15);textcolor(0);
     printdirection(" e-mail: is_Laouici@esi.dz ","right",77,18,15);
